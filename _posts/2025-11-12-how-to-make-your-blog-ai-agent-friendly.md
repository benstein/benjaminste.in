...
excerpt: "I added two lines to my blog's HTML header. Those two lines enabled AI agents to read my blog posts directly—not just humans with browsers anymore."
---
